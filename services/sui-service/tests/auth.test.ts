...
// Mock @mysten/sui/verify so unit tests don't need real Ed25519 keypairs.
// A non-empty signature resolves successfully; empty string rejects.
jest.mock('@mysten/sui/verify', () => ({
  verifyPersonalMessageSignature: jest.fn(
    (_message: Uint8Array, signature: string, _opts: { address: string }) => {
