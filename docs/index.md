...
#### Getting Started
1. Connect SUI wallet—**SSO** (email, phone, or social login—no extension needed), Slush, Sui Wallet, or any SuiNS-compatible wallet. If your wallet has multiple accounts, you will be asked to select which account to sign in with.
